  ...
  return (
    <>
      ...
      <Button
        ...
        borderRadius={20}
        h={170}>
        <ButtonText color="black" fontFamily="PoppinsBold" size="2xl">
      ...
      <Modal
        ...
        <ModalContent>
          <ModalHeader>
            <Heading size="lg">Rescue Request</Heading>
            <ModalCloseButton>
              <Icon as={CloseIcon} />
            </ModalCloseButton>
          </ModalHeader>
          <ModalBody>
            <Text>Are you sure you want to send a Rescue Resquest?</Text>
          </ModalBody>
          <ModalFooter>
            <Button
              variant="outline"
...
export default SendRescueRequest;
